...
export default class Plantas_Horticolas extends Component {
  constructor(props) {
    super(props);
    this.state = {
       productos:[],
  ...
  async componentDidMount(){
    const res = await axios.get('http://localhost:3001/api/Productos/Plantas_Horticolas');
      ...
      <div class="container row" style={{minWidth:'108%',minHeight:"670px",paddingLeft:"50px",backgroundSize:'contain',backgroundImage:"url(https://ak.picdn.net/shutterstock/videos/18869951/thumb/1.jpg)",backgroundColor:'rgb(100,100,100',backgroundBlendMode:'soft-light'}}>
        <div className="col-md-12" style={{padding: "25px 0"}}>
          <ol style={{background:"rgb(92 90 90)",borderRadius:"10px"}}  className="col-md-6 breadcrumb">
            ...
            <li>
              <i style={{color: "antiquewhite",fontSize:"1.20em"}} class="faExteriorMigas"> Plantas Horticolas </i>
            </li>
          </ol>
        </div>    
