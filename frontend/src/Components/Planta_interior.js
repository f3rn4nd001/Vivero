...
export default class Plantas_Interior extends Component {
  constructor(props) {
    super(props);
    this.state = {
       productos:[],
  ...
  async componentDidMount(){
    const res = await axios.get('http://localhost:3001/api/Productos/PlantasInterior');
      ...
      <div class="container row" style={{minWidth:'108%',minHeight:"670px",paddingLeft:"50px",backgroundSize:'contain',backgroundImage:"url(https://ak.picdn.net/shutterstock/videos/18869951/thumb/1.jpg)",backgroundColor:'rgb(100,100,100',backgroundBlendMode:'soft-light'}}>
        <div className="col-md-12" style={{padding: "25px 0"}}>
          <ol style={{background:"rgb(92 90 90)",borderRadius:"10px"}}  className="col-md-4 breadcrumb">
            ...
            <li>
            <svg style={{color: "antiquewhite"}} xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-cloud-fill" viewBox="0 0 16 16">
                                                <path d="M4.406 3.342A5.53 5.53 0 0 1 8 2c2.69 0 4.923 2 5.166 4.579C14.758 6.804 16 8.137 16 9.773 16 11.569 14.502 13 12.687 13H3.781C1.708 13 0 11.366 0 9.318c0-1.763 1.266-3.223 2.942-3.593.143-.863.698-1.723 1.464-2.383z"/>
                                                </svg>
              <i style={{color: "antiquewhite",fontSize:"1.20em"}} class="faExteriorMigas"> Plantas de Interior </i>
            </li>
          </ol>
        </div>    
